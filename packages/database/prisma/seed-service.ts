...
async function main() {
  ...
  const zixlyTenant = await prisma.tenant.upsert({
    ...
    create: {
      id: 'zixly-org-001',
      name: 'Zixly',
      industry: 'pipeline Automation Services',
    },
  })
  ...
  const financialData = [
    ...
    // SEQ Accounting Services - Professional Package
    {
      ...
      metadata: {
        ...
        projectType: 'pipeline + Metabase + Nextcloud',
        consultant: 'cole@zixly.com.au',
        duration: '4 weeks',
      },
    },
  ...
  // Create workflow metadata for Zixly's internal pipeline workflows
  const workflows = [
    {
      tenantId: zixlyTenant.id,
      workflowId: 'pipeline_workflow_001',
    ...
    {
      tenantId: zixlyTenant.id,
      workflowId: 'pipeline_workflow_002',
    ...
    {
      tenantId: zixlyTenant.id,
      workflowId: 'pipeline_workflow_003',
